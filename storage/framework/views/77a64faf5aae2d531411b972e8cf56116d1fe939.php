                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><?php echo e(trans('labels.business_setting')); ?></h4>
                            <a href="<?php echo e(route('admin.business_setting.add')); ?>" class="btn btn-raised btn-primary btn-min-width mr-1 mb-1 float-right" style="margin-top: -30px;">
                                <?php echo e(trans('labels.add_level')); ?>

                            </a>
                        </div>

                        <div class="col-md-4">
                            <form method="GET" action="<?php echo e(route('admin.business_setting.search')); ?>">
                        ...
                        <div class="card-body collapse show">
                            <div class="card-block card-dashboard" id="table-display">
                                ...
                                <?php echo $__env->make('Admin.business_setting.business_settingtable', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eglobalmart\resources\views/Admin/business_setting/index.blade.php ENDPATH**/ ?>