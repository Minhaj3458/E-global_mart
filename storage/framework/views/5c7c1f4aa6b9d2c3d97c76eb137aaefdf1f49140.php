<?php $__env->startSection('title'); ?>
    <?php echo e(Helper::webinfo()->site_title); ?> | Users
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="col-md-4">
                            <form method="GET" action="<?php echo e(route('admin.users.search')); ?>">
                        ...
                        <div class="card-body collapse show">
                            <div class="card-block card-dashboard" id="table-display">
                                    <?php echo $__env->make('Admin.users.userstable', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        Swal.fire({
            ...
            if(t.value==true){
                ...
                $.ajax({
                    ...
                    url: '<?php echo e(route("admin.users.changeStatus")); ?>',
                    type: "POST",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eglobalmart\resources\views/Admin/users/index.blade.php ENDPATH**/ ?>