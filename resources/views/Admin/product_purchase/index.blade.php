...
@section('title')
    {{Helper::webinfo()->site_title}} | {{ trans('labels.purchase') }}
@endsection
@section('css')
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ trans('labels.purchase') }}</h4>
                            <a href="{{route('admin.purchase.create')}}" class="btn btn-raised btn-primary btn-min-width mr-1 mb-1 float-right" style="margin-top: -30px;">
                                {{ trans('labels.add_purchase') }}
                            </a>
                        </div>

                        <div class="col-md-4">
                            <form method="GET" action="{{route('admin.supplier.search')}}">
                        ...
                        <div class="card-body collapse show">
                            <div class="card-block card-dashboard" id="table-display">
                                ...
                                @include('Admin.product_purchase.purchase_table')
                            </div>
                        </div>
                    </div>
                </div>
