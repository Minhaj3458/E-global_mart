<table class="table table-striped table-bordered zero-configuration">
    ...
    <tbody> 
        ...
        <tr id="del-<?php echo e($row->id); ?>">
            ...
            <td>
                <a href="<?php echo e(URL::to('admin/category/show/'.$row->id)); ?>" class="success p-0 edit" title="<?php echo e(trans('labels.edit')); ?>" title="<?php echo e(trans('labels.edit')); ?>" data-original-title="<?php echo e(trans('labels.edit')); ?>">
                ...
                <?php else: ?>
                    <a href="javascript:void(0);" class="danger p-0" data-original-title="<?php echo e(trans('labels.delete')); ?>" title="<?php echo e(trans('labels.delete')); ?>" onclick="do_delete('<?php echo e($row->id); ?>','<?php echo e(route('admin.category.delete')); ?>','<?php echo e(trans('labels.delete_category')); ?>','<?php echo e(trans('labels.delete')); ?>')">
                        <i class="ft-trash font-medium-3"></i>
                    </a>
                <?php endif; ?>
            </td>
...
<nav aria-label="Page navigation example">
    ...
    <?php endif; ?>
</nav><?php /**PATH C:\xampp\htdocs\eglobalmart\resources\views/Admin/category/categorytable.blade.php ENDPATH**/ ?>