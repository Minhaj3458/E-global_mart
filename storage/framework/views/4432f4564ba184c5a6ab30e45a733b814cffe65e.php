        ...
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
         ...
         <!-- Products -->
            <li class=" nav-item <?php echo e(Request::routeIs('admin.products*') ? 'active is-shown open' : ''); ?>">
                <a href="<?php echo e(route('admin.products.admin_product_show')); ?>"><i class="fa fa-list"></i><span class="menu-title"><?php echo e(trans('labels.products')); ?></span></a>
             </li>
          <!-- Home page settings -->
          <li class="has-sub nav-item">
            <a href="#">
          ...
          <!-- Products -->
            <li class=" nav-item <?php echo e(Request::routeIs('admin.supplier*') ? 'active is-shown open' : ''); ?>">
                <a href="<?php echo e(route('admin.supplier')); ?>"><i class="fa fa-list"></i><span class="menu-title"><?php echo e(trans('labels.supplier')); ?></span></a>
             </li>
          ...
          <!-- Purchase -->
          <li class=" nav-item <?php echo e(Request::routeIs('admin.supplier*') ? 'active is-shown open' : ''); ?>">
                <a href="<?php echo e(route('admin.purchase')); ?>"><i class="fa fa-list"></i><span class="menu-title"><?php echo e(trans('labels.purchase')); ?></span></a>
          </li>
          ...
          <!-- Stockiest -->
            <li class=" nav-item <?php echo e(Request::routeIs('admin.stockiest*') ? 'active is-shown open' : ''); ?>">
                <a href="<?php echo e(route('admin.stockiest')); ?>"><i class="fa fa-credit-card" aria-hidden="true"></i><span class="menu-title"><?php echo e(trans('labels.manage_stockiest')); ?></span></a>
            </li>
          ...
          <?php if(Auth::user()->type == 3): ?>
           ...
           <!-- Vendoor -->
                    ...
                    <li class=" ">
            <a href=""><i class="fa fa-list"></i><span class="menu-title"><?php echo e(trans('labels.Referals')); ?></span></a>
          </li>
          <!--vendoors-->
