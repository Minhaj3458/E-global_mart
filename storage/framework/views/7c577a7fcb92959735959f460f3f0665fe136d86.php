<table class="table table-striped table-bordered zero-configuration">
    <thead>
        <tr>
            ...
            <th><?php echo e(trans('labels.brand_name')); ?></th>
    ...
    <tbody> 
        ...
        <tr id="del-<?php echo e($row->id); ?>">
            <td><?php echo e(++$n); ?></td>
            <td><img src='<?php echo e(Helper::image_path($row->icon)); ?>' class='media-object round-media height-50'></td>
            ...
            <td>
                <a href="<?php echo e(URL::to('admin/brand/show/'.$row->id)); ?>" class="success p-0 edit" title="<?php echo e(trans('labels.edit')); ?>" title="<?php echo e(trans('labels.edit')); ?>" data-original-title="<?php echo e(trans('labels.edit')); ?>">
                ...
                <?php else: ?>
                    <a href="javascript:void(0);" class="danger p-0" data-original-title="<?php echo e(trans('labels.delete')); ?>" title="<?php echo e(trans('labels.delete')); ?>" onclick="do_delete('<?php echo e($row->id); ?>','<?php echo e(route('admin.brand.delete')); ?>','<?php echo e(trans('labels.delete_brand')); ?>','<?php echo e(trans('labels.delete')); ?>')">
                        <i class="ft-trash font-medium-3"></i>
                    </a>
                <?php endif; ?>
            </td>
...
<nav aria-label="Page navigation example">
    ...
    <?php endif; ?>
</nav><?php /**PATH C:\xampp\htdocs\eglobalmart\resources\views/Admin/brand/brandtable.blade.php ENDPATH**/ ?>