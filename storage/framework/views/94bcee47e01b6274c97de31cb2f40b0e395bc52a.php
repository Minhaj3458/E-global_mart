                ...
                <div class="col-12">
                    ...
                    <div class="card">                       
                        <div class="card-header">
                            <h4 class="card-title"><?php echo e(trans('labels.coupons')); ?></h4>
                            <a href="<?php echo e(route('admin.coupons.add')); ?>" class="btn btn-raised btn-primary btn-min-width mr-1 mb-1 float-right" style="margin-top: -30px;">
                                <?php echo e(trans('labels.add_coupons')); ?>

                            </a>
                        </div>

                        <div class="col-md-4">
                            <form method="GET" action="<?php echo e(route('admin.coupons.search')); ?>">
                        ...
                        <div class="card-body collapse show">
                            <div class="card-block card-dashboard" id="table-display">
                                    <?php echo $__env->make('Admin.coupons.couponstable', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function couponsTable() {
        $('#preloader').show();
        $.ajax({
            url:"<?php echo e(route('admin.coupons.list')); ?>",
            method:'get',
        ...
        Swal.fire({
            ...
            if(t.value==true){
                ...
                $.ajax({
                    ...
                    url: '<?php echo e(route("admin.coupons.changeStatus")); ?>',
                    type: "POST",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eglobalmart\resources\views/Admin/coupons/index.blade.php ENDPATH**/ ?>