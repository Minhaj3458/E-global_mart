                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ trans('labels.manage_stockiest') }}</h4>
                            <a href="{{route('admin.stockiest.create')}}" class="btn btn-raised btn-primary btn-min-width mr-1 mb-1 float-right" style="margin-top: -30px;">
                                {{ trans('labels.add_stock') }}
                            </a>
                        </div>

                        <div class="col-md-4">
                            <form method="GET" action="{{route('admin.stockiest.search')}}">
                        ...
                        <div class="card-body collapse show">
                            <div class="card-block card-dashboard" id="table-display">
                                @include('Admin.stockiest.stockiest_table')
                            </div>
                        </div>
                    </div>
                </div>
