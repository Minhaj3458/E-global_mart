                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php endif; ?>
                            <div class="px-3">
                                <form class="form" method="post" action="<?php echo e(route('admin.stockiest.store')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="user_id" id="user_id">
                                                ...
                                                <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $show): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($show->id); ?>"><?php echo e($show->mobile); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="stock_name" class="form-control" name="stock_name" placeholder="<?php echo e(trans('placeholder.stoct_name')); ?>" value="<?php echo e(old('amount')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" id="address" class="form-control" name="address" placeholder="<?php echo e(trans('placeholder.address')); ?>" value="<?php echo e(old('address')); ?>"></textarea>
