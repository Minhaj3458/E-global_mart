<?php $__env->startSection('title'); ?>
    <?php echo e(Helper::webinfo()->site_title); ?> | <?php echo e(trans('labels.purchase')); ?>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><?php echo e(trans('labels.purchase')); ?></h4>
                            <a href="<?php echo e(route('admin.purchase.create')); ?>" class="btn btn-raised btn-primary btn-min-width mr-1 mb-1 float-right" style="margin-top: -30px;">
                                <?php echo e(trans('labels.add_purchase')); ?>

                            </a>
                        </div>

                        <div class="col-md-4">
                            <form method="GET" action="<?php echo e(route('admin.supplier.search')); ?>">
                        ...
                        <div class="card-body collapse show">
                            <div class="card-block card-dashboard" id="table-display">
                                ...
                                <?php echo $__env->make('Admin.product_purchase.purchase_table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function CategoryTable() {
        $('#preloader').show();
        $.ajax({
            url:"<?php echo e(route('admin.category.list')); ?>",
            method:'get',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eglobalmart\resources\views/Admin/product_purchase/index.blade.php ENDPATH**/ ?>