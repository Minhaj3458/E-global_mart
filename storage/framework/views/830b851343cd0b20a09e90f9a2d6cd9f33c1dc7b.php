<table class="table table-striped table-bordered zero-configuration">
    ...
    <tbody> 
        ...
        <tr id="del-<?php echo e($row->id); ?>">
            ...
            <td><?php echo e($row['innersubcategory']->innersubcategory_name); ?></td>
            <td>
                <?php echo e($row->product_name); ?>

                <?php if($row->is_variation == 0): ?>
                    <?php if($row->product_qty <= $row->available_stock): ?>
                    <br>
                    <span class="badge badge-danger">Low QTY</span>
                    <?php endif; ?>
                <?php endif; ?>
                <?php if($row->is_variation == 1): ?>
                    <?php $__currentLoopData = $row['variations']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $variations): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($variations->qty <= $row->available_stock): ?>
                            <br>
                            <span class="badge badge-danger">Low QTY</span>
                            <?php break; ?>
                        <?php endif; ?>
            ...
            <td>
                <a href="<?php echo e(URL::to('admin/products/show/'.$row->id)); ?>" class="success p-0 edit" title="<?php echo e(trans('labels.edit')); ?>" title="<?php echo e(trans('labels.edit')); ?>" data-original-title="<?php echo e(trans('labels.edit')); ?>">
                ...
                <?php else: ?>
                    <a href="javascript:void(0);" class="danger p-0" data-original-title="<?php echo e(trans('labels.delete')); ?>" title="<?php echo e(trans('labels.delete')); ?>" onclick="do_delete('<?php echo e($row->id); ?>','<?php echo e(route('admin.products.delete')); ?>','<?php echo e(trans('labels.delete_product')); ?>','<?php echo e(trans('labels.delete')); ?>')">
                        <i class="ft-trash font-medium-3"></i>
                    </a>
                <?php endif; ?>
            </td>
...
<nav aria-label="Page navigation example">
    ...
    <?php endif; ?>
</nav><?php /**PATH C:\xampp\htdocs\eglobalmart\resources\views/Admin/products/productstable.blade.php ENDPATH**/ ?>